...
class Cell:
    ...
    def __sub__(self, other):
        if (self.cellule - other.cellule) <= 0:
            return  ("Количество ячеек в первой клетке меньше чем во второй. Вычитание невозможно.")
        else:
            return self.cellule - other.cellule
    ...
    def __truediv__(self, other):
         if self.cellule // other.cellule == 0:
             return ("Количество ячеек в первой клетке меньше чем во второй. Деление невозможно.")
         else:
             return self.cellule // other.cellule
    ...
    def make_order(self, a):
        i = 1
        part_1 = ''
        for i in range(1, (self.cellule // a + 1)):
            part_1 = part_1 + '*' * a + 'n'
            i += 1
        part_1 = part_1 + '*' * (self.cellule % a)
        return part_1
...
"""Требуется ввести значение 'a' для организации клеток по рядам: """
print("Организация клеток по рядам: ", cell_1.make_order(2))